...
export default defineThemeConfig({
  logo: '',
  docsRepo: 'https://github.com/tesiwoo/tesiwoo.github.io',
  docsDir: 'docs',
  appearance: 'true',
  profile: {
    avatar: 'avatar.jpg',
  ...
  notes,
  social: [
    { icon: 'github', link: 'https://github.com/tesiwoo/tesiwoo.github.io' },
  ...
  footer:{
    message: '🥼 感谢<a target="_blank" href="https://github.com/zhenghaoyang24">Hoey</a> & ✒️ Tesiwoo'
  },
})
