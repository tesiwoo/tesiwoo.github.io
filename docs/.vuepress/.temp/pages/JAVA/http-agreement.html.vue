<template><div><h1 id="http协议" tabindex="-1"><a class="header-anchor" href="#http协议"><span>HTTP协议</span></a></h1>
<p>HTTP协议是<strong>超文本传输协议</strong>，用于从万维网服务器传输超文本到浏览器的传输协议。</p>
<p>它是<strong>基于TCP/IP通信协议</strong>来传递数据的。</p>
<p>HTTP协议工作于C/S（客户端/服务器）架构上。</p>
<p>属于<strong>应用层</strong>，<strong>面向对象的</strong>协议。</p>
<p><strong>特点：</strong></p>
<ul>
<li>简单快速</li>
<li>灵活</li>
<li>无连接（每次只处理一个请求）</li>
<li>无状态（不保存传输的信息，<strong>HTTP1.1版本后引入Cookie技术</strong>）</li>
<li>支持B/S、C/S架构</li>
</ul>
<p><strong>URL</strong></p>
<p>http协议使用统一资源定标识符（Uniform Resources Identifiers：URI）来传输数据和建立连接。</p>
<p>URL是一种特殊的URI，全称为统一资源定位符（Uniform Resources Locader）。它包含了用于查找某个资源所需要的所有信息。用于在互联网上确认某一处的资源</p>
<p>组成：</p>
<p>​	<strong><code v-pre>协议部分</code>://<code v-pre>域名部分</code>:<code v-pre>端口部门</code>/<code v-pre>虚拟目录部分</code>/<code v-pre>文件名部分</code>?<code v-pre>参数部门</code>#<code v-pre>锚部分</code></strong></p>
...
<p>1XX：消息（没看到过哈哈哈）</p>
<p>2XX：成功</p>
<p>3XX：重定向（再来一道面试题：你知道301和302的区别吗？都是重定向哦，答案在最后）</p>
<p>4XX：客户端错误（检查路径，参数等）</p>
<p>5XX：服务端错误（打开命令窗口查看错误）</p>
<p><strong>HTTP工作原理</strong></p>
<ol>
<li>客户端连接到Web服务器（先会通过DNS解析 域名找到服务端的ip地址咯，绕后通过TCP三次握手建立连接，这个我写过）</li>
<li>发送http请求</li>
<li>服务端接受请求并返回http响应</li>
<li>释放TCP连接</li>
<li>客户端浏览器解析响应正文展示到浏览器窗口</li>
</ol>
...
<h1 id="http的get和post的区别" tabindex="-1"><a class="header-anchor" href="#http的get和post的区别"><span>HTTP的GET和POST的区别</span></a></h1>
...
<ul>
<li>
<p>get 方法一般用于请求，比如你在浏览器地址栏输入 www.cxuanblog.com 其实就是发送了一个 get 请求，它的主要特征是请求服务器返回资源，而 post 方法一般用于</p>
