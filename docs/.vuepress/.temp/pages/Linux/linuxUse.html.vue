...
<blockquote>
<p>为什么要学习Linux？</p>
<p>因为后面的消息队列（Kafka，activeMQ，RabbitMQ，RorketMQ）、缓存（Redis）、搜索引擎（ES）、集群分布式（需要购买多台服务器，没有服务器我们就只能试用虚拟机）不能放在一台机器上</p>
</blockquote>
<h2 id="linux简介" tabindex="-1"><a class="header-anchor" href="#linux简介"><span>Linux简介</span></a></h2>
<p>Linux内核最初是由芬兰人林纳斯·托瓦兹（Linus Torvalds）在赫尔辛基大学上学时处于个人爱好而编写的。</p>
<p>Linux是一套免费试用和自由传播的类Unix操作系统，是一个基于POSIX（可移植操作系统接口）和UNIX的多用户、多任务、支持多线程和多CPU的操作系统。</p>
<p>Linux能运行主要的UNIX工作软件、应用程序和网络协议。它支持32位和64位硬件。Linux继承了Unix以网络为核心的设计思想，是一个性能稳定的多用户网络操作系统。</p>
<h1 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令"><span>常用命令</span></a></h1>
<h2 id="开机登录" tabindex="-1"><a class="header-anchor" href="#开机登录"><span>开机登录</span></a></h2>
<p>开机会启动许多程序，它们在Windows叫做服务（service），在Linux就叫做“守护进程”（daemon）。</p>
<p>开机成功后，它会显示一个文本登录界面。</p>
<p>一般来说，用户的登录方式有三种：</p>
<ul>
<li>命令行登录</li>
<li>ssh登录</li>
...
<div class="language-base line-numbers-mode" data-highlighter="prismjs" data-ext="base"><pre v-pre><code class="language-base"><span class="line">sync # 将数据由内存同步到硬盘中。</span>
<span class="line"></span>
<span class="line">shutdown # 关机指令，你可以man shutdown 来看一下帮助文档。例如你可以运行如下命令关机：</span>
<span class="line"></span>
<span class="line">shutdown –h 10 # 这个命令告诉大家，计算机将在10分钟后关机</span>
<span class="line"></span>
<span class="line">shutdown –h now # 立马关机</span>
<span class="line"></span>
<span class="line">shutdown –h 20:25 # 系统会在今天20:25关机</span>
<span class="line"></span>
<span class="line">shutdown –h +10 # 十分钟后关机</span>
<span class="line"></span>
<span class="line">shutdown –r now # 系统立马重启</span>
<span class="line"></span>
<span class="line">shutdown –r +10 # 系统十分钟后重启</span>
<span class="line"></span>
<span class="line">reboot # 就是重启，等同于 shutdown –r now</span>
<span class="line"></span>
<span class="line">halt # 关闭系统，等同于shutdown –h now 和 poweroff</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>==不管是重启系统还是关闭系统，首先要运行 <strong>sync</strong> 命令，把内存中的数据写到磁盘中。==</p>
<h2 id="系统目录结构" tabindex="-1"><a class="header-anchor" href="#系统目录结构"><span>系统目录结构</span></a></h2>
<p><img src="@source/../resource/images/image-20201021123038025.png" alt="image-20201021123038025"></p>
...
<h2 id="目录管理" tabindex="-1"><a class="header-anchor" href="#目录管理"><span>目录管理</span></a></h2>
<ul>
<li>ls: 列出目录</li>
<li>cd：切换目录（有绝对路径和相对路径的写法）</li>
<li>pwd：显示目前的目录</li>
...
<blockquote>
<p>可以通过man命令查看各个命令的用法、如：man cp</p>
</blockquote>
<blockquote>
<p>ls：列出命令</p>
<p>选项和参数：</p>
<ul>
<li>-a：全部的文件，包括隐藏文件（开头为 . 的文件）一起列出来</li>
<li>-l：长数据串列出，包含文件的属性和权限等等数据；</li>
</ul>
</blockquote>
<blockquote>
<p>cd：切换目录</p>
...
<p>语法：</p>
<div class="language-base line-numbers-mode" data-highlighter="prismjs" data-ext="base"><pre v-pre><code class="language-base"><span class="line">cd [相对路径或绝对路径]</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>测试：</p>
<div class="language-base line-numbers-mode" data-highlighter="prismjs" data-ext="base"><pre v-pre><code class="language-base"><span class="line"># 切换到用户目录下</span>
<span class="line">[root@kuangshen /]# cd home  </span>
<span class="line"></span>
<span class="line"># 使用 mkdir 命令创建 kuangstudy 目录</span>
<span class="line">[root@kuangshen home]# mkdir kuangstudy</span>
<span class="line"></span>
<span class="line"># 进入 kuangstudy 目录</span>
<span class="line">[root@kuangshen home]# cd kuangstudy</span>
<span class="line"></span>
<span class="line"># 回到上一级</span>
<span class="line">[root@kuangshen kuangstudy]# cd ..</span>
<span class="line"></span>
<span class="line"># 回到根目录</span>
<span class="line">[root@kuangshen kuangstudy]# cd /</span>
<span class="line"></span>
<span class="line"># 表示回到自己的家目录，亦即是 /root 这个目录</span>
<span class="line">[root@kuangshen kuangstudy]# cd ~</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote>
<blockquote>
...
<p>测试：```base</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># 单纯显示出目前的工作目录</span>
<span class="line">[root@kuangshen ~]# pwd</span>
<span class="line">/root</span>
<span class="line"></span>
<span class="line"># 如果是链接，要显示真实地址，可以使用 -P参数</span>
<span class="line">[root@kuangshen /]# cd bin</span>
<span class="line">[root@kuangshen bin]# pwd -P</span>
<span class="line">/usr/bin</span>
<span class="line"></span></code></pre>
...
<li>-p：帮助你直接将所需要的目录（包含上一级目录）递归创建出来</li>
</ul>
<p>eg : mkdir -m 711 test1    #创建一个权限为rwxrwx--x的test1目录</p>
</blockquote>
<blockquote>
<p>redir ：删除空的目录</p>
<p>语法：rmdir [-p] 目录名称</p>
<ul>
<li>-p：连同上一级空的目录也一起删除</li>
</ul>
<p>==注意：==redir只能删除空的目录，可以使用rm命令删除非空目录</p>
</blockquote>
<blockquote>
<p>cp：复制文件或目录</p>
<p>语法：cp [-adfilprsu] 来源（source） 目标（target）</p>
<p>也可以一次性移动多个文件：cp [options] source1 source2 source3... directory</p>
<p>选项与参数：</p>
<ul>
...
<p>mv：移动文件或目录或修改名称</p>
<p>语法：</p>
<p>移动文件：mv [-fiu] source destination</p>
<p>移动多个文件：mv [options] source1 source2 srouce3... directory</p>
<p>选项与参数：</p>
<ul>
...
<h2 id="文件的基本属性" tabindex="-1"><a class="header-anchor" href="#文件的基本属性"><span>文件的基本属性</span></a></h2>
<h3 id="看懂文件属性" tabindex="-1"><a class="header-anchor" href="#看懂文件属性"><span>看懂文件属性</span></a></h3>
<p>Linux系统是一种典型的多用户系统，不同的用户处于不同的地位，拥有不同的权限。为了保护系统的安全性，Linux系统对不同的用户访问同一文件（包括目录文件）的权限做了不同的规定。</p>
<p>在Linux中我们可以使用<code v-pre>ll</code>或者<code v-pre>ls –l</code>命令来显示一个文件的属性以及文件所属的用户和组，如：</p>
<p><img src="@source/../resource/images/image-20201025221739574.png" alt="image-20201025221739574"></p>
<p>第一个字符代表这个文件是目录，文件还是链接文件等。</p>
<ul>
...
<p>接下来的9个字符，分别代表对应用户权限：</p>
<p><img src="@source/../resource/images/image-20201026102508013.png" alt="image-20201026102508013"></p>
<blockquote>
<p>修改文件属性</p>
<ul>
<li>chgrp：更改文件属组
<ul>
<li>chgrp [-R] 属组名 文件名</li>
</ul>
</li>
</ul>
<p>-R：递归更改文件属组，就是更改某个目录文件的属组时，如果加上-R选项，那么该目录下的所有文件的属组都会更改。</p>
<ul>
<li>
...
<div class="language-base line-numbers-mode" data-highlighter="prismjs" data-ext="base"><pre v-pre><code class="language-base"><span class="line">r:4     w:2         x:1</span>
<span class="line"></span></code></pre>
...
<div class="language-base line-numbers-mode" data-highlighter="prismjs" data-ext="base"><pre v-pre><code class="language-base"><span class="line">chmod 770 filename</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ul>
</blockquote>
<h3 id="文件内容查看" tabindex="-1"><a class="header-anchor" href="#文件内容查看"><span>文件内容查看</span></a></h3>
<blockquote>
<p>概述</p>
</blockquote>
...
<p>语法：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">cat [-AbEnTv]</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">[root@kuangshen ~]# tac /etc/sysconfig/network-scripts/ifcfg-eth0</span>
<span class="line">ONBOOT=yes</span>
<span class="line">BOOTPROTO=dhcp</span>
...
<p>语法：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">nl [-bnw] 文件</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>选项与参数：</p>
<ul>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">[root@kuangshen etc]# more /etc/csh.login....(中间省略)....--More--(28%) # 重点在这一行喔！你的光标也会在这里等待你的命令</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">[root@kuangshen etc]# more /etc/csh.login....(中间省略)....:   # 这里可以等待你输入命令！</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><blockquote>
<p>head  取出文件前面几行</p>
</blockquote>
<p>语法：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">head [-n number] 文件</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">[root@kuangshen etc]# head -n 20 /etc/csh.login</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><blockquote>
<p>tail  取出文件后面几行</p>
</blockquote>
<p>语法：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">tail [-n number] 文件</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>选项与参数：</p>
<ul>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">[root@kuangshen etc]# tail -n 20 /etc/csh.login</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><blockquote>
<p>拓展：Linux 链接概念</p>
</blockquote>
...
<h1 id="vim使用及账号用户管理" tabindex="-1"><a class="header-anchor" href="#vim使用及账号用户管理"><span>Vim使用及账号用户管理</span></a></h1>
<h2 id="vim编辑器是什么" tabindex="-1"><a class="header-anchor" href="#vim编辑器是什么"><span>Vim编辑器是什么</span></a></h2>
...
<p>连 vim 的官方网站 (http://www.vim.org) 自己也说 vim 是一个程序开发工具而不是文字处理软件。</p>
<p>vim 键盘图：<img src="@source/../resource/images/image-20201027103616197.png" alt="image-20201027103616197"></p>
<h2 id="三种使用模式" tabindex="-1"><a class="header-anchor" href="#三种使用模式"><span>三种使用模式</span></a></h2>
...
<p><img src="@source/../resource/images/image-20201027103644574.png" alt="image-20201027103644574"></p>
<h2 id="vim-按键说明" tabindex="-1"><a class="header-anchor" href="#vim-按键说明"><span>Vim 按键说明</span></a></h2>
...
<h1 id="账号管理" tabindex="-1"><a class="header-anchor" href="#账号管理"><span>账号管理</span></a></h1>
...
<h2 id="用户账号的管理" tabindex="-1"><a class="header-anchor" href="#用户账号的管理"><span>用户账号的管理</span></a></h2>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">useradd 选项 用户名</span>
<span class="line"></span></code></pre>
...
<p>测试：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># 此命令创建了一个用户chuyx，其中-m选项用来为登录名chuyx生一个主目录 /home/chuyx[root@chuyx home]# useradd -m chuyx</span>
<span class="line"></span></code></pre>
...
<p><strong>$表示普通用户</strong></p>
<p><strong>#表示超级用户，也就是root用户</strong></p>
<h3 id="删除帐号" tabindex="-1"><a class="header-anchor" href="#删除帐号"><span>删除帐号</span></a></h3>
<p>如果一个用户的账号不再使用，可以从系统中删除。</p>
<p>删除用户账号就是要将/etc/passwd等系统文件中的该用户记录删除，必要时还删除用户的主目录。</p>
<p>删除一个已有的用户账号使用userdel命令，其格式如下：</p>
<div class="language-base line-numbers-mode" data-highlighter="prismjs" data-ext="base"><pre v-pre><code class="language-base"><span class="line">userdel 选项 用户名</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">[root@kuangshen home]# userdel -r kuangshen</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">usermod 选项 用户名</span>
<span class="line"></span></code></pre>
...
<p>例如：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># usermod -s /bin/ksh -d /home/z –g developer kuangshen</span>
<span class="line"></span></code></pre>
...
<p>命令的格式为：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">passwd 选项 用户名</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">$ passwdOld password:******New password:*******Re-enter new password:*******</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># passwd kuangshenNew password:*******Re-enter new password:*******</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># passwd -d kuangshen</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># passwd -l kuangshen</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">groupadd 选项 用户组</span>
<span class="line"></span></code></pre>
...
<p>实例1：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># groupadd group1</span>
<span class="line"></span></code></pre>
...
<p>实例2：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># groupadd -g 101 group2</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">groupdel 用户组</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>例如：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># groupdel group1</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">groupmod 选项 用户组</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># 此命令将组group2的组标识号修改为102。groupmod -g 102 group2# 将组group2的标识号改为10000，组名修改为group3。groupmod –g 10000 -n group3 group2</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><blockquote>
<p>切换组</p>
</blockquote>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">$ newgrp root</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">＃ cat /etc/passwdroot:x:0:0:Superuser:/:daemon:x:1:1:System daemons:/etc:bin:x:2:2:Owner of system commands:/bin:sys:x:3:3:Owner of system files:/usr/sys:adm:x:4:4:System accounting:/usr/adm:uucp:x:5:5:UUCP administrator:/usr/lib/uucp:auth:x:7:21:Authentication administrator:/tcb/files/auth:cron:x:9:16:Cron daemon:/usr/spool/cron:listen:x:37:4:Network daemon:/usr/net/nls:lp:x:71:18:Printer administrator:/usr/spool/lp:</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">用户名:口令:用户标识号:组标识号:注释性描述:主目录:登录Shell</span>
<span class="line"></span></code></pre>
...
<p>常见的伪用户如下所示：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">伪 用 户 含 义bin 拥有可执行的用户命令文件sys 拥有系统文件adm 拥有帐户文件uucp UUCP使用lp lp或lpd子系统使用nobody NFS使用</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><blockquote>
<p>/etc/shadow</p>
</blockquote>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">登录名:加密口令:最后一次修改时间:最小时间间隔:最大时间间隔:警告时间:不活动时间:失效时间:标志</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">组名:口令:组标识号:组内用户列表</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ol>
<li>
...
<h1 id="磁盘管理" tabindex="-1"><a class="header-anchor" href="#磁盘管理"><span>磁盘管理</span></a></h1>
<blockquote>
<p>概述</p>
</blockquote>
...
<p>语法：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">df [-ahikHTm] [目录或文件名]</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>选项与参数：</p>
<ul>
...
<p>语法：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">du [-ahskm] 文件或目录名称</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>选项与参数：</p>
<ul>
...
<p>磁盘挂载语法：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">mount [-t 文件系统] [-L Label名] [-o 额外选项] [-n] 装置文件名 挂载点</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>测试：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># 将 /dev/hdc6 挂载到 /mnt/hdc6 上面！[root@www ~]# mkdir /mnt/hdc6[root@www ~]# mount /dev/hdc6 /mnt/hdc6[root@www ~]# dfFilesystem           1K-blocks     Used Available Use% Mounted on/dev/hdc6              1976312     42072   1833836   3% /mnt/hdc6</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">umount [-fn] 装置文件名或挂载点</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>选项与参数：</p>
<ul>
...
<p>卸载/dev/hdc6</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">[root@www ~]# umount /dev/hdc6</span>
<span class="line"></span></code></pre>
...
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># 执行：startup.sh -->启动tomcat# 执行：shutdown.sh -->关闭tomcat./startup.sh./shutdown.sh</span>
<span class="line"></span></code></pre>
...
<ol>
<li>
<p>官网安装参考手册：https://docs.docker.com/install/linux/docker-ce/centos/</p>
</li>
<li>
<p>确定你是CentOS7及以上版本</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">[root@192 Desktop]# cat /etc/redhat-releaseCentOS Linux release 7.2.1511 (Core)</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>yum安装gcc相关（需要确保 虚拟机可以上外网 ）</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">yum -y install gccyum -y install gcc-c++</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>卸载旧版本</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">yum -y remove docker docker-common docker-selinux docker-engine# 官网版本yum remove docker \          docker-client \          docker-client-latest \          docker-common \          docker-latest \          docker-latest-logrotate \          docker-logrotate \          docker-engine</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>安装需要的软件包</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">yum install -y yum-utils device-mapper-persistent-data lvm2</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>设置stable镜像仓库</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line"># 错误yum-config-manager --add-repo https://download.docker.com/linux/centos/docker-ce.repo## 报错[Errno 14] curl#35 - TCP connection reset by peer[Errno 12] curl#35 - Timeout# 正确推荐使用国内的yum-config-manager --add-repo http://mirrors.aliyun.com/docker-ce/linux/centos/docker-ce.repo</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>更新yum软件包索引</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">yum makecache fast</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>安装Docker CE</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">yum -y install docker-ce docker-ce-cli containerd.io</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>启动docker</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">systemctl start docker</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
<li>
<p>测试</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code class="language-text"><span class="line">docker versiondocker run hello-worlddocker images</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div></li>
</ol>
<h3 id="宝塔面板安装" tabindex="-1"><a class="header-anchor" href="#宝塔面板安装"><span>宝塔面板安装</span></a></h3>
<p>https://www.bilibili.com/video/av91821322</p>
<p>说明：后面我们会在Linux搭建很多环境，每个环境的搭建留在每个对应的课程中去讲解、比如Redis、Kafka、Elasticsearch等等..... 这里大家只需要掌握基本的套路即可！</p>
</div></template>
